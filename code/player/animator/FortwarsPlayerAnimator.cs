...
public class FortwarsPlayerAnimator : PawnAnimator
{
	...
	public override void Simulate()
	{
		...
		if ( HasTag( "slide" ) ) slide = slide.LerpTo( 1.0f, Time.Delta * 10.0f );
		else slide = slide.LerpTo( 0.0f, Time.Delta * 5.0f );

		SetAnimParameter( "duck", duck );
		SetAnimParameter( "skid", slide );
